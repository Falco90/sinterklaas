...
<div class="wrapper">
  ...
  <div id="items">
    ...
    <button type="button" class="btn btn-success" id="addNew" data-toggle="modal" data-target="#exampleModal">Voeg nieuwe wenslijst toe</button>  
      <div class="modal" tabindex="-1" role="dialog" id="exampleModal">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="title">Nieuwe wenslijst</h5>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" id="addButton" data-dismiss="modal">Voeg nieuwe wenslijst toe</button>
            </div>
          </div>
        </div>
      </div>
